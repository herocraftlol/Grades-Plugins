...
async function ensureTables() {
  ...
  `);
  // Alimentee par le plugin (PlayerTrackingListener) a chaque connexion/
  // deconnexion/mort. IF NOT EXISTS : ne casse rien si le plugin a deja
  // cree cette table de son cote (voir DatabaseManager.java).
  await pool.query(`
